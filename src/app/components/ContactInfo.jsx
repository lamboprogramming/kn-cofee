...
export default function ContactInfo() {
  return (
    <div className='pt-2 '>
      <div className="flex flex-col items-center justify-center mt-4 space-y-0.5 sm:mt-4 gap-4 ">

        <div className="flex items-center space-x-0.5 font-serif font-thin tracking-wider text-gray-800 text-sm sm:text-lg gap-0.5  ">
